...
const  toalCategoryTasks=document.querySelector("#category-tasks");
...
const calculateTotal=()=>{
    ...
    toalCategoryTasks.innerHTML=`${categoryTasks.length} Tasks`;
...
// lets add functionality to add new tsks
